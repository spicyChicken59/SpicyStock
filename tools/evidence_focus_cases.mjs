...
if (process.argv.includes('--dom')) {
  ...
  for (const width of [1440, 390]) for (const row of excerpt.bursts) {
    ...
    for (const file of ['docs/design-system/sc-charts.js', 'docs/app-chart.js', 'docs/app-map.js', 'docs/app-follow.js', 'docs/app-reading.js', 'docs/app-method.js', 'docs/app.js']) {

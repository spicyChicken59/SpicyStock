...
async function open(data, shared=hub()) {
 ...
 for(const f of ['docs/design-system/sc-charts.js','docs/app-chart.js','docs/app-map.js','docs/app-follow.js','docs/app-reading.js','docs/app-method.js','docs/app.js']) { if(baseline && (f==='docs/app-reading.js'||f==='docs/app-method.js')) continue; w.eval(await source(f)); }
